...
/*
   ...
   - la funzione restituisce TRUE (1) se ogni elemento di valore dispari (in posizione i-esima di A) è duplicato nella lista B, FALSE (0) altrimenti.

   - Ad esempio, se A = (0, 1, 2, 3), allora la funzione restituisce TRUE se B = (0, 1, 1, 2, 3, 3) e FALSE se ad esempio B = (0, 1, 2, 3). 
   Ulteriori esempi sono presenti nei test. 

   NB: una funzione che supera i test non e' necessariamente corretta.

NOTE GENERALI:es3-lists.c
